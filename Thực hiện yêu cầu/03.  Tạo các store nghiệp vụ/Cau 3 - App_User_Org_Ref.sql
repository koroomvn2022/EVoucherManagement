...
begin
    ...
    delete from App_User_Org_Ref where App_User_Org_Ref_Id=@App_User_Org_Ref_Id
...
begin
    ...
    select * from App_User_Org_Ref where App_User_Org_Ref_Id=@App_User_Org_Ref_Id
...
begin
    ...
    from App_User_Org_Ref a 
    where 1=1 
    order by App_User_Org_Ref_Id
...
begin
    ...
    select a.* from App_User_Org_Ref a 
